...
import auth, {GithubProvider, GoogleProvider, XProvider,} from "../auth/Firebase";
...
const SignInOverlay: React.FC<SignInProps> = ({onAuthStateChanged}) => {
    ...
    return (
        <div
            className="w-[335px] h-fit flex flex-col gap-[20px] p-4 bg-richBlack/[.65] backdrop-blur-[10px] rounded-[34px] border-[1.5px] border-white/20 overlay-show">
