...
const MangaInfo: React.FC<MangaInfoProps> = (props) => {
    ...
    return (
        <div
            className="font-primary w-[340px] h-fit flex flex-col gap-[20px] p-4 bg-richBlack/[.55] backdrop-blur-[10px] rounded-[26px] border-[1.5px] border-white/20">
            <div className="w-full h-fit flex flex-row items-start gap-[20px]">
                <div
                    className="w-[100px] h-[140px] rounded-[10px] outline outline-[1px] outline-white/20 outline-offset-[-1px] relative overflow-hidden">
            ...
            <div className="w-full h-fit flex flex-col gap-[5px]">
                ...
                <p className="w-full text-xs text-white opacity-75 font-medium leading-5 max-h-[160px] text-ellipsis overflow-hidden">
                    {description}
                </p>
            </div>
        </div>
