...
const MangaInfoOverplay: React.FC<MangaInfoProps> = (props) => {
    ...
    return (
        <div
            className="manga-info-overlay font-primary w-[320px] h-fit flex flex-col gap-[20px] p-4 bg-richBlack/75 backdrop-blur-[10px] rounded-[26px] border-[1.5px] border-white/20">
