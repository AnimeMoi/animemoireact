...
const SignUpOverlay: React.FC<SignUpProps> = ({ onEmailSignUp, onGoogleSignUp, onXSignUp, onFacebookSignUp }) => {
    ...
    return (
        <div className="font-primary w-[335px] h-fit flex flex-col gap-[20px] p-4 bg-richBlack/50 backdrop-blur-[10px] rounded-[34px] border-[1.5px] border-white/20 overlay-show">
            <p className="text-lg text-lightGray font-semibold text-center">Đăng ký</p>
