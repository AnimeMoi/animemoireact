                            ...
                            <div className="flex flex-row items-center gap-[15px]">
                                <div className="relative">
                                    ...
                                    {isSearchResultVisible && (
                                        <div className="absolute top-[150%] left-1/2 -translate-x-1/2 z-[200]">
                                            <div
                                                className="w-[480px] max-h-[379px] bg-richBlack/[.85] backdrop-blur-[10px] flex flex-col flex-grow gap-[20px] p-[20px] rounded-[22px] border-[1.5px] border-white/20 overflow-y-scroll no-scrollbar overlay-show">
                                                {chaptersFilter.map((chapter: any) => (
                                                    ...
                                                    >
                                                        <Link
                                                            ...
                                                            className={`w-[300px] text-[13px] text-lightGray hover:text-[#d9f21c] font-semibold whitespace-nowrap text-ellipsis overflow-hidden flex items-center`}
