                ...
                <div className="relative">
                  ...
                  {isSearchResultVisible && (
                    <div className="absolute top-[150%] left-1/2 -translate-x-1/2 z-[200]">
                      <div className="w-[480px] max-h-[379px] bg-richBlack/[.85] backdrop-blur-[10px] flex flex-col flex-grow gap-[20px] p-[20px] rounded-[22px] border-[1.5px] border-white/20 overflow-y-scroll no-scrollbar overlay-show">
