    ...
    return (
        <div className="font-primary w-[320px] h-fit flex flex-col gap-[30px] p-5 bg-richBlack/[.55] backdrop-blur-[10px] rounded-3xl border-[1.5px] border-white/20">
            <div className="w-full h-fit flex flex-col gap-2.5">
                ...
                <p className="text-xs text-white opacity-75 font-medium">Cảm ơn bạn đã hỗ trợ báo lỗi, truyện sẽ được fix trong thời gian sớm nhất.</p>
            </div>
            <div className="w-full h-fit flex flex-col gap-5">
                <label className="w-full h-fit flex flex-row gap-2.5">
                    <input type="checkbox" name="option" className="w-[16px] h-[16px]"/>
                    <span className="text-xs text-lightGray font-medium">Ảnh bị lỗi, không thấy ảnh</span>
                </label>
                <label className="w-full h-fit flex flex-row gap-2.5">
                    <input type="checkbox" name="option" className="w-[16px] h-[16px]"/>
                    <span className="text-xs text-lightGray font-medium">Chapter bị trùng</span>
                </label>
                <label className="w-full h-fit flex flex-row gap-2.5">
                    <input type="checkbox" name="option" className="w-[16px] h-[16px]"/>
                    <span className="text-xs text-lightGray font-medium">Chapter chưa dịch</span>
                </label>
                <label className="w-full h-fit flex flex-row gap-2.5">
                    <input type="checkbox" name="option" className="w-[16px] h-[16px]"/>
                    <span className="text-xs text-lightGray font-medium">Up sai truyện</span>
                </label>
            </div>
