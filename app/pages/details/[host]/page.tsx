        ...
        <div className="w-screen min-h-screen flex justify-center items-center bg-richBlack">
            <div
                ...
                <div className="w-full h-fit flex sticky top-0 z-[100]">
                    <NavBar isHomePage={false} isGenres={true}/>
                </div>
                <div className="w-full min-h-[calc(100vh-90px-50px)] flex flex-col gap-[50px]">
                    <div className="w-full h-fit flex flex-row flex-wrap justify-center gap-[40px]">
                        <MangaDetail host={params.params.host} params={params}/>
                        <ChapterList host={params.params.host} params={params}/>
                    </div>
                    <Donate/>
                    <div className={`text-white text-sm font-medium`}>
                        <p>Ngôi sao màu xanh có nghĩa là chương đã được đồng bộ với máy chủ</p>
                        <p className={`text-xs`}>- Khi bạn đọc trên 80% chương truyện sẽ bắt đầu đồng bộ với máy chủ</p>
                        <p>Ngôi sao màu trắng có nghĩa là chương đã đọc ở máy của bạn</p>
                        <p className={`text-xs`}>- Khi bạn bắt đầu đọc chương sẽ được lưu ngay</p>
                    </div>
                    <div
                        className="w-full h-fit flex flex-row justify-between items-center pt-[25px] py-[50px] border-t-[1px] border-white/[.15]">
