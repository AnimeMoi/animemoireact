...
export default function Page() {
    ...
    const [dataChartDataComicUpdateByMonth, setDataChartDataComicUpdateByMonth] = useState({
        datasets: []
    });
    ...
    const getDataChartDataComicUpdateByMonth = useCallback(async () => {
        ...
        await fetch(`${Domain}Admin/ChartDataComicUpdateByMonth?month=${_date.getMonth() + 1}/1/${_date.getFullYear()}`)
                    ...
                    <>
                        ...
                        <div className="w-full h-fit flex flex-col gap-5">
                            ...
                            <div className="w-full h-fit flex flex-row gap-[28px]">
                                <div
                                    className="w-[266px] h-[88px] flex flex-row items-center gap-[20px] px-[16px] rounded-[16px] bg-[#0f0f0f] border-[1px] border-white/[.07] cursor-pointer move-up">
                                    <div
