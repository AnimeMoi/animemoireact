...
export default function Page() {
    ...
    const [monthlyChartData, setMonthlyChartData] = useState({datasets: []});
    const [comicChartData, setComicChartData] = useState<{ labels: any[], datasets: any[] }>({
        labels: [],
        datasets: []
    });
    ...
    return (
        <div className="w-screen min-h-screen flex justify-center bg-richBlack">
            <div
                className="hidden w-[1200px] h-full tablet:flex flex-col justify-start items-center gap-[50px] px-[40px]">
                {user === null ? (
                    ...
                    <>
                        <div
                            className="w-full h-[85px] flex flex-row justify-between items-center bg-richBlack border-b-[1px] border-white/[.15] sticky top-0 z-[100]">
                        ...
                        <div className="w-full h-fit flex flex-col gap-[25px] mb-2.5">
                            ...
                            <div className="w-full h-fit flex flex-row gap-[28px]">
                                <div
                                    className="w-[260px] h-[90px] flex flex-row items-center gap-[20px] px-[16px] rounded-[16px] bg-[#0f0f0f] border-[1px] border-white/[.07] cursor-pointer move-up">
                                    <div
                                        className="w-[44px] h-[44px] flex justify-center items-center rounded-full bg-lightGray">
                        ...
                        <div className="w-full h-fit flex flex-col gap-[25px] mb-2.5">
                            ...
                            <div
                                className="w-full h-fit p-5 rounded-[16px] bg-[#0f0f0f] border-[1px] border-white/[.07] cursor-pointer move-up">
                                <Line
